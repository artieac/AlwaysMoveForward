...
namespace AlwaysMoveForward.Core.Common.DataLayer.Dapper
{
    ...
    public class UnitOfWork : IUnitOfWork, IDisposable
    {
        ...
        protected void StartSession()
        {
            if (this.currentSession == null)
            {
                this.currentSession = new SqlConnection(this.ConnectionString);
            }
        }
        ...
        public IDisposable BeginTransaction(IsolationLevel isolationLevel)
        {
            ...
            {
                this.Logger.LogError("Unable to start transaction, no session established.");
            }
        ...
        public void EndTransaction(bool canCommit)
        {
            ...
            {
                LogManager.CreateLogger<UnitOfWork>().LogError("Unable to end transaction, no session established.");
            }
        }
