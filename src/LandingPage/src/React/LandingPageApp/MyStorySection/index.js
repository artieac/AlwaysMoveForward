            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col col-8">
                        <p>I am a VP of Engineering/Chief Architect, hockey player,, Disney fan, and family man.</p>
                        <p>As a VP of Engineering I&#x27;m a firm believer in modern practices such as AI First Culture, Servant Leadership, Domain Driven Design, Microservices, Containers, CI/CD, Dev Ops and deploying to the cloud. I most enjoy designing and building distributed systems built using microservices, but I&#x27;m not too particular about what technology I use to build them. I have built production systems in Java, .Net/.Net Core, and Node deployed to AWS and Azure, but I'm open to other things as well.</p>
                        ...
                        <p>I&#x27;m a big Disney fan. I've loved going to Disney World since I was a kid,, and I never seem to get sick of it. Everything from the theming, to the rides, to the food. Every time I go there I'm trying to soak it all in. My favorite park is probably Magic Kingdom, and my favorite ride is Rise of the Resistance (it was Splash Mountain but that is sadly a thing of the past).</p>
