...
namespace AlwaysMoveForward.OAuth2.Web.Code.Extensions
{
    public class Pager
    {
        ...
        private string GeneratePageLink(string linkText, int pageNumber)
        {
            ...
            VirtualPathContext virtualPathContext = new VirtualPathContext(this.viewContext.HttpContext, this.linkWithoutPageValuesDictionary, pageLinkValueDictionary);
            VirtualPathData virtualPathData = this.viewContext.RouteData.Routers[0].GetVirtualPath(virtualPathContext);
