...
namespace AlwaysMoveForward.AnotherBlog.UnitTest.IntegrationTests.Repository
{
    ...
    public class CommentRepositoryTest : RepositoryTestBase
    {
        ...
        {
            IList<Comment> foundItems = this.RepositoryManager.CommentRepository.GetAllApproved(Constants.Blog.TestId);
        ...
        {
            IList<Comment> foundItems = this.RepositoryManager.CommentRepository.GetAllDeleted(Constants.Blog.TestId);
        ...
        {
            IList<Comment> foundItems = this.RepositoryManager.CommentRepository.GetAllUnapproved(Constants.Blog.TestId);
        ...
        {
            IList<Comment> foundItems = this.RepositoryManager.CommentRepository.GetByBlogId(Constants.Blog.TestId);
        ...
        {
            IList<Comment> foundItems = this.RepositoryManager.CommentRepository.GetByPostId(Constants.BlogEntry.TestId);
        ...
        public void CommentRepository_SaveTest()
        {
            ...
            itemToSave.PostId = Constants.BlogEntry.TestId;
