...
namespace AlwaysMoveForward.Common.Configuration
{
    ...
    /// </summary>
    public class DatabaseConfigurationTwo : AlwaysMoveForward.Common.Encryption.EncryptedConfigurationSection
    {
        /// <summary>
        ...
        public static DatabaseConfigurationTwo GetInstance()
        {
            return DatabaseConfigurationTwo.GetInstance(DEFAULT_SECTION);
        }
        ...
        /// <returns>Database configuration instance</returns>
        public new static DatabaseConfigurationTwo GetInstance(string configurationSection)
        {
            return (DatabaseConfigurationTwo)System.Configuration.ConfigurationManager.GetSection(configurationSection);
        }

        /// <summary>
        /// Default constructor
        /// </summary>
        public DatabaseConfigurationTwo()
        { }
