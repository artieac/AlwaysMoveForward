...
{
    public class DbInfoRepository : ActiveRecordRepositoryA<DbInfo, DbInfoDTO>, IDbInfoRepository
    {
        public DbInfoRepository(IUnitOfWork unitOfWork, IRepositoryManager repositoryManager)
