...
<head id="Head1" runat="server">
    ...
    <title><%= MvcApplication.SiteInfo.Url %> Error</title>
    <meta name="Description" content="<%= MvcApplication.SiteInfo.Url %> Error" />
		        ...
		        <div class="bodyContainer">
		            <div class="bodyContent">        
                        <h3>
                            ...
                            <br />
                            Click <a href="http://www.alwaysmoveforward.com/">here</a> to return to the main page.
                        </h3>
                    </div>
    		    </div>
		        <br />
