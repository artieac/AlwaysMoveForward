...
using AnotherBlogTest.BlogPostReference;

namespace AnotherBlogTest.WebServiceTests
{
    [TestFixture]
    public class BlogPostServiceTests
    {
        ...
        public void GetBlogsTest()
        {
            ...
            IList<AnotherBlogTest.BlogPostReference.BlogElement> foundBlogs = testClient.GetBlogs(request).Blogs;
        ...
        public void GetBlogEntriesTest()
        {
            ...
            IList<AnotherBlogTest.BlogPostReference.BlogElement> foundBlogs = testClient.GetBlogs(blogRequest).Blogs;
            ...
            if (foundBlogs != null)
            {
                for (int i = 0; i < foundBlogs.Count; i++)
                {
                    ...
                    IList<AnotherBlogTest.BlogPostReference.BlogPostElement> entryList = testClient.GetAllBlogEntriesByBlog(entryRequest).BlogEntries;
