...
{
    public class BlogListRepository : ActiveRecordRepository<BlogList, BlogListDTO, IBlogList>, IBlogListRepository
    {
        ...
        public IList<BlogList> GetByBlog(int blogId)
        {
            ...
            return Castle.ActiveRecord.ActiveRecordMediator<BlogListDTO>.FindAll(criteria);
        }
    }
}
